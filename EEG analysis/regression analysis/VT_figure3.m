...
%% Figure 3A/ Figure S3
par.hp = 0; %HP filter >1Hz for Fig. S3
par.lp = 1; %LP filter <6Hz for Viz. 
VT_figure3A(exp,par)

%% Figure 3B - CPP ~ LLR + LLR*surprise
par.chans = exp.centroParietal; %[1:128]%exp.centroParietal;%Which channels to include in cluster analysis?
